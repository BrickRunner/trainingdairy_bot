...
RUNNING_STANDARDS = {
    'men': {
        ...
        0.4: {  # 400 м
            ...
            'I': 52.84,
            'II': 56.54,
            'III': time_to_seconds("1:01.44"),
            '1ю': time_to_seconds("1:06.84"),
        ...
        0.6: {  # 600 м
            ...
            'III': time_to_seconds("1:37.24"),
            '1ю': time_to_seconds("1:45.24"),
        ...
        0.8: {  # 800 м
            ...
            'I': time_to_seconds("1:59.34"),
            'II': time_to_seconds("2:08.24"),
            'III': time_to_seconds("2:18.24"),
            '1ю': time_to_seconds("2:30.24"),
        ...
        1.0: {  # 1000 м
            ...
            'III': time_to_seconds("3:03.24"),
            '1ю': time_to_seconds("3:18.24"),
        ...
        1.5: {  # 1500 м
            ...
            'I': time_to_seconds("4:11.74"),
            'II': time_to_seconds("4:27.24"),
            'III': time_to_seconds("4:45.24"),
            '1ю': time_to_seconds("5:05.24"),
        ...
        3.0: {  # 3000 м
            ...
            'III': time_to_seconds("10:30.24"),
            '1ю': time_to_seconds("11:20.24"),
        ...
        100.0: {  # 100000 м
            ...
            'I': time_to_seconds("7:50:00"),
            'II': time_to_seconds("8:20:00"),
            'III': time_to_seconds("8:50:00"),
        },
    },
    'women': {
        0.06: {  # 60 м
        ...
        0.4: {  # 400 м
            ...
            'МС': 54.19,
            'КМС': 57.24,
            'I': time_to_seconds("1:00.74"),
            'II': time_to_seconds("1:05.14"),
            'III': time_to_seconds("1:10.84"),
            '1ю': time_to_seconds("1:16.04"),
        ...
        0.6: {  # 600 м
            ...
            'III': time_to_seconds("1:58.24"),
            '1ю': time_to_seconds("2:07.44"),
        ...
        0.8: {  # 800 м
            ...
            'I': time_to_seconds("2:21.34"),
            'II': time_to_seconds("2:33.34"),
            'III': time_to_seconds("2:46.34"),
            '1ю': time_to_seconds("2:59.34"),
        ...
        1.0: {  # 1000 м
            ...
            'III': time_to_seconds("3:37.24"),
            '1ю': time_to_seconds("3:54.24"),
        ...
        1.5: {  # 1500 м
            ...
            'I': time_to_seconds("4:59.34"),
            'II': time_to_seconds("5:21.34"),
            'III': time_to_seconds("5:46.34"),
            '1ю': time_to_seconds("6:14.34"),
        ...
        3.0: {  # 3000 м
            ...
            'III': time_to_seconds("12:58.34"),
            '1ю': time_to_seconds("14:03.34"),
        ...
        5.0: {  # 5000 м
            ...
            'I': time_to_seconds("18:45.34"),
            'II': time_to_seconds("20:20.34"),
            'III': time_to_seconds("22:05.34"),
        ...
        100.0: {  # 100000 м
            ...
            'I': time_to_seconds("10:00:00"),
            'II': time_to_seconds("11:00:00"),
            'III': time_to_seconds("12:00:00"),
        },
    },
}
...
def get_qualification_running(distance_km: float, time_seconds: float, gender: str) -> Optional[str]:
    ...
    Args:
        distance_km: Дистанция в километрах (0.06, 0.1, 0.2, ..., 42.2, 100.0)
        time_seconds: Время прохождения дистанции в секундах
        gender: Пол ('male' или 'female')
